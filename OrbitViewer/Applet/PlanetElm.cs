...
namespace OrbitViewer.Applet
{
	class PlanetElm
	{
		...
		#region Planet elements

		/// <summary>
		/// Mercury
		/// </summary>
		public static PlanetElmP1 MercuryE = new PlanetElmP1(
		...
		/// Venus
		/// </summary>
		public static PlanetElmP1 VenusE = new PlanetElmP1(
		...
		/// Mars
		/// </summary>
		public static PlanetElmP1 MarsE = new PlanetElmP1(
		...
		/// Jupiter
		/// </summary>
		public static PlanetElmP1 JupiterE = new PlanetElmP1(
		...
		/// Saturn
		/// </summary>
		public static PlanetElmP1 SaturnE = new PlanetElmP1(
		...
		/// Uranus
		/// </summary>
		public static PlanetElmP2 UranusE = new PlanetElmP2(
		...
		/// Neptune
		/// </summary>
		public static PlanetElmP2 NeptuneE = new PlanetElmP2(
		...
		#region Perturbation correction for Jupiter
		...
		#region Perturbation correction for Saturn
		...
		double PerturbationElement(double eta, double zeta, int[] tbl)
		{
			...
			double vv1 = (double)tbl[z1 * 13 + e1];
			double vv2 = (double)tbl[z1 * 13 + e2];
			double vv3 = (double)tbl[z2 * 13 + e1];
			double vv4 = (double)tbl[z2 * 13 + e2];
			double pp1 = vv1 + (vv3 - vv1) * (zeta / 30.0 - (double)z1);
			double pp2 = vv2 + (vv4 - vv2) * (zeta / 30.0 - (double)z1);
			double pp3 = pp1 + (pp2 - pp1) * (eta / 30.0 - (double)e1);
			return pp3;
		}

		#endregion

		#region PerturbationJupiter
	...
	class PlanetElmP1
	{
		...
		public double w, w1, w2, w3;
		public double N, N1, N2, N3;
		public double i, i1, i2, i3;
		public double e, e1, e2, e3;
		public double a;

		public PlanetElmP1(double L, double L1, double L2, double L3,
							double w, double w1, double w2, double w3,
							double N, double N1, double N2, double N3,
							double i, double i1, double i2, double i3,
							double e, double e1, double e2, double e3,
							double a)
		{
			this.L = L; this.L1 = L1; this.L2 = L2; this.L3 = L3;
			this.w = w; this.w1 = w1; this.w2 = w2; this.w3 = w3;
			this.N = N; this.N1 = N1; this.N2 = N2; this.N3 = N3;
			this.i = i; this.i1 = i1; this.i2 = i2; this.i3 = i3;
	...
	class PlanetElmP2
	{
							...
							double i, double i1, double i2)
		{
			...
			this.w = w; this.w1 = w1; this.w2 = w2;
			this.N = N; this.N1 = N1; this.N2 = N2;
			this.a = a; this.a1 = a1; this.a2 = a2;
			this.e = e; this.e1 = e1; this.e2 = e2;
			this.i = i; this.i1 = i1; this.i2 = i2;
		}
	}
